...
{
    public BaseRepository(DbContext repositoryDbContext, IMapper<TDalEntity, TDomainEntity> mapper) : base(repositoryDbContext, mapper)
    {
    }
}
    ...
    where TKey : IEquatable<TKey>
{
    ...
    protected virtual bool UseUserIdFilter => true;
    
    protected virtual bool ShouldUseUserId(TKey? userId = default!)
    {
        if (!UseUserIdFilter) return false;
